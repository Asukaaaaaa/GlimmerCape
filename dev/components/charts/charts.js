    ...
    render() {
        return (
            <div className={style.main} title={this.props.title}>
                ...
                {this.props.type == 'main' && <this.Controls />}
            </div>
        )
    }
        ...
        return (
            <div className={ClassNames('ct-controls', active && 'active')}>
                <div className='cc-button'
                    ...
                    <svg t="1575819608404" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2917" width="64" height="64">
