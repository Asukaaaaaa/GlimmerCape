          ...
          {uinfo.photo ? (
            ...
            <div className="st-form">
              <div className="sign-mode">
                <div
                  className={signinMode == "user" ? "active" : ""}
                  onClick={e => setSigninMode("user")}>
                  用户
                </div>
                <div
                  className={signinMode == "admin" ? "active" : ""}
                ...
                handleSubmit={values => {
                  if (signinMode == "user")
                    ajaxer
                      ...
                      .then(res => {
                        ajaxer
                          .post("/user/getUserInfo", {user_id: res})
                          .then(uinfo => {
          ...
          <div className="st-switch">
            {(uinfo.photo && (
              ...
              <p>
                如何操作？
                <span
                  onClick={e => window.location.replace("./guide/intro.html")}>
                  引导
                </span>
              </p>
            )}
        ...
        <div className="st-signup">
          ...
          <Form
            ...
            handleSubmit={values => {
              ...
              ajaxer.post("/user/signUp", data).then(res => {
                setUinfo({
